 ...
 */
class Po extends \App\Entity\Po implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Po $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setNumber(string $Number): \App\Entity\Po
    {
     ...
     * {@inheritDoc}
     */
    public function setActive(bool $Active): \App\Entity\Po
    {
