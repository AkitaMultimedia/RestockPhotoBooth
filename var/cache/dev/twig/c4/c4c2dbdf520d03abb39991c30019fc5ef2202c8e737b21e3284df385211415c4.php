...
class __TwigTemplate_fed4fa3e01cfa62ac531adff562c12c05c0290dffe63e664ef57aab8f51dc5c3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  103 => 12,  93 => 11,  80 => 7,  76 => 6,  72 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <div class=\"flex_column_centered\">
        <a href=\" {{ path('admin_polist', {'active':1}) }} \" class=\"btn btn-option\">Active PO</a>
        <a href=\" {{ path('admin_polist', {'active':0}) }} \" class=\"btn btn-option\">Archived PO</a>
        <a href=\" {{ path('settings_menu') }} \" class=\"btn btn-option\">Settings</a>
    </div>
 {% endblock %}
...
", "admin/admin.html.twig", "/Users/sebastiendumont/Documents/Projets/restock/restockApp/templates/admin/admin.html.twig");
    }
}
